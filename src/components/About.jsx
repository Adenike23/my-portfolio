    ...
    return (
        <main className="bg-gray-200 rounded-b-3xl mt-[4rem]">
            ...
            <motion.div  className="flex justify-center items-center flex-col w-[90%] md:w-[45%] mx-auto text-center mt-5 pb-10">
                ...
                <div className="text-2xl md:text-4xl font-extrabold text-white tracking-wide bg-gradient-to-r from-gray-300 via-gray-500 to-gray-800 bg-clip-text text-transparent">Hello! I am Adenike Adeofe</div>
