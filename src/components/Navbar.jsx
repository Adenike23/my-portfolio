    ...
    return (
        <header className="flex justify-between items-center px-1 md:px-5 py-1 fixed w-[100%] z-10 bg-gray-200 top-0 text-xs md:text-base">
            <div className="flex items-center gap-1" initial={{y: -250, opacity: 0}} animate={{ y: 1, opacity: 1 }} transition={{ duration: .5, ease: "easeInOut",mass: 0.4, damping: 4, type: 'spring', stiffness: 100 }}>
                ...
                <motion.button whileHover={{textShadow: '0px 0px 8px rgb(211, 211, 211)', boxShadow: '0px 0px 8px rgb(255, 255, 255)', scale: 1.1, transition: {duration: 0.5} }} className="rounded-full bg-gray-100 py-2 px-4 font-medium"><a href="/Adenike-Adeofe_Resume.pdf" className="resume-link" target="_blank" rel="noopener noreferrer">Resume</a></motion.button>
            </div>
